...
-- CreateEnum
CREATE TYPE "StatusDocumento" AS ENUM ('NaoLido', 'Lido', 'Arquivado');
...
CREATE TABLE "documentos" (
    ...
    "status" "StatusDocumento" NOT NULL DEFAULT 'NaoLido',
    "criadoEm" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "empresaId" TEXT NOT NULL,
    "responsavelId" TEXT,
...
-- CreateIndex
CREATE INDEX "documentos_responsavelId_idx" ON "documentos"("responsavelId");
